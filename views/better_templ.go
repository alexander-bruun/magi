...
func Better(currentPage int) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if len(duplicates) == 0 {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 2, "<div class=\"uk-alert-success\" uk-alert><div class=\"uk-flex uk-flex-middle uk-flex-center\"><uk-icon icon=\"BadgeCheck\" size=\"32\" class=\"mr-3\"></uk-icon><p class=\"text-lg uk-margin-remove\">No duplicate media found in any library!</p></div></div>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		} else {
			...
			for _, dup := range duplicates {
				...
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 10, "</code></td><td class=\"uk-text-center\"><div class=\"uk-flex uk-flex-center uk-flex-middle flex-gap-8\"><button class=\"uk-btn uk-btn-secondary uk-btn-small\" hx-post=\"")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
