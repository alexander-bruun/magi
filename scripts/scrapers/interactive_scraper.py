...
SCRAPERS = {
    ...
    '8': {'name': 'Manga18', 'file': 'manga18.py', 'default_folder': 'Manga18'},
    '9': {'name': 'MangaKatana', 'file': 'mangakatana.py', 'default_folder': 'MangaKatana'},
    '10': {'name': 'ManhwaGalaxy', 'file': 'manhwagalaxy.py', 'default_folder': 'ManhwaGalaxy'},
    '11': {'name': 'Omega Scans', 'file': 'omegascans.py', 'default_folder': 'OmegaScans'},
    '12': {'name': 'Qi Scans', 'file': 'qiscans.py', 'default_folder': 'QiScans'},
    '13': {'name': 'Reset Scans', 'file': 'resetscans.py', 'default_folder': 'ResetScans'},
    '14': {'name': 'Thunder Scans', 'file': 'thunderscans.py', 'default_folder': 'ThunderScans'},
    '15': {'name': 'UToon', 'file': 'utoon.py', 'default_folder': 'UToon'},
    '16': {'name': 'Vortex Scans', 'file': 'vortexscans.py', 'default_folder': 'VortexScans'},
    '17': {'name': 'Z Scans', 'file': 'zscans.py', 'default_folder': 'ZScans'},
}
