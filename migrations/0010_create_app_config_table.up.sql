...
CREATE TABLE IF NOT EXISTS app_config (
    ...
    require_login_for_content INTEGER NOT NULL DEFAULT 1, -- 1 = true (require login to view/read manga), 0 = false
...
INSERT INTO app_config (id, allow_registration, max_users, content_rating_limit, require_login_for_content, metadata_provider, mal_api_token, anilist_api_token)
SELECT 1, 1, 0, 3, 0, 'mangadex', '', ''
